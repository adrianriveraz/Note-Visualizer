# Program by: Joseph Sperry, Adrian Rivera-Zayas, James Knight, Brian Bregenzer
import sys
import random
import math
import os  #
    ...
    def main(self, sense):
        ...
        while trys <> 0:
            ...
            while True:
                ...
                if 0 > soundgate:  #### basic noise gate to stop it guessing ambient noises
                    continue
                ...
                if shownotes:
                    ...
                    if err >= 1.5 and err <= 2.5:
                        sencolor = [255,255,255]
                    if err > 2.5:
                        sencolor = [255,0,0]

                    sense.show_message(str(tunerNotes[frequencies[targetnote]]), text_colour = sencolor)
                # update the display
